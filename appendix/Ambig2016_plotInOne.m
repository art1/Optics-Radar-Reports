...
switch coding
    case 1
        %6 Pulses
        z=[1 0 0 1];
        U=[0 1 1 z 1 z 1 z 1 z 1 z 1 1 0]
        P=zeros(1,length(U));
    case 2
        %Long Pulse
        U=ones(1,10)
    ...
    case 4
        ...
        P=zeros(1,length(U));
    case 5
        codelength=input('Length of code (3, 4,or 8): ');
        switch codelength
            case 3
                U=[ones(1,3) zeros(1,7) ones(1,3)];
                P=[0 0 1 zeros(1,7) 0 1/2 0]*pi;
            case 4
                U=[ones(1,4) zeros(1,17) ones(1,4)];
                 P=[0 1 0 0 zeros(1,17) 0 0 0 1]*pi;
            case 8
                U=[ [1  1  1 -1 1  1  -1 1  zeros(1,15) 1 1 1 -1 -1 -1 1 -1]];
                P=zeros(1,length(U));
            
            otherwise
                ('Length of code (3,4 or 8): ')
                return
        end
    case 6
        U=ones(1,51);
